...
use think\douyin\Platform;

/**
 * 抖音开发工具包
 */
class Douyin extends Manager
{
	/**
     * 驱动的命名空间
     * @var string
     */
	protected $namespace = '\\think\\douyin\\handler\\';
    ...
    public function getConfig($name = null, $default = null)
    {
        // 读取指定配置
        if (!is_null($name)) {
            return $this->app->config->get('douyin.' . $name, $default);
        }
        // 返回全部配置
        return $this->app->config->get('douyin');
    }
